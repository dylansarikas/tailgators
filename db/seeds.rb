...
Stadium.create(latitude: '39.7439', longitude: '-105.0201', name: 'Mile High Stadium', team: 'Denver Broncos',
               image: 'milehigh.jpg', description: 'The Denver Broncos are a professional American football team based in Denver, Colorado. Established in 1960, they are a member of the National Football League (NFL) and known for their iconic orange and blue uniforms. The Broncos have a rich history, with three Super Bowl championships and numerous playoff appearances. They play their home games at Empower Field at Mile High, a stadium renowned for its altitude and passionate fans. The Broncos are celebrated for their strong defensive teams and legendary players, including Hall of Fame quarterback John Elway. Their fierce rivalries, particularly with the Las Vegas Raiders and Kansas City Chiefs, add to their storied legacy.', nick_name: 'broncos', address: "1701 Bryant St, Denver, CO 80204")
Stadium.create(latitude: '33.9535', longitude: '-118.3390', name: 'SoFi Stadium', team: 'Los Angeles Chargers',
               image: 'sofi.jpg', description: 'The Los Angeles Chargers are a professional American football team based in Los Angeles, California. Founded in 1960, the team originally played in Los Angeles before relocating to San Diego for several decades and then returning to L.A. in 2017. Known for their powder blue and gold uniforms, the Chargers have a history of high-powered offenses and dynamic playmakers. They play their home games at SoFi Stadium, a state-of-the-art venue they share with the Los Angeles Rams. The Chargers are beloved for their exciting style of play and have a passionate fan base that continues to grow in Southern California.', nick_name: 'chargers', address: "1001 Stadium Dr, Inglewood, CA 90301")
